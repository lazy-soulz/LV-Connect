...
import SliderRight from '../../components/micros/SliderRight';
...
const ContactsPage = () => {
    ...
    const [isNewContactClick, setIsNewContactClick] = useState(false)
    ...
    console.log(isNewContactClick, "THIS IS ")
    // Dummy data
    const contacts = [
        {
            id: 1,
    ...
    return (
       ...
       <div className='bg-[#FFFFFF] w-full h-full rounded-[8px] px-[55px] py-[18px]'>
            ...
            <div className='flex justify-between items-center mb-4'>
                ...
                <button onClick={() => setIsSliderOpen(true)}  className='bg-[#2B6CB0] text-[#FFFFFF] text-[14px] font-inter font-[600] border-none px-[16px] py-[8px] rounded-[4px] w-fit'>
                    Add Contact
                </button>
            </div>
